...
class Patch:
    ...
    def update_instructions(self) -> None:
        ...
        ##################################
        address = 0x803b1d10
        new_instruction = b'\x3c\x60\x80\x00\x88\x63\x18\x82\x7c\x03\x20\x00\x41\x80\x00\x0c\x38\x60\x00\x01\x42\x80\x00\x08\x38\x60\x00\x00\x60\x00\x00\x00\x60\x00\x00\x00\x60\x00\x00\x00\x60\x00\x00\x00\x60\x00\x00\x00\x60\x00\x00\x00'
        self.dol.write_data(fs.write_bytes, address, new_instruction)
