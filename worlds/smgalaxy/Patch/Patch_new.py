...
class Patch:
    def __init__(self, patcher: WiiIsoPatcher, patch_path: str, output: dict):
        ...
        self.astrodome: AstroDome = AstroDome(patcher)
...
class SuperMarioGalaxyRandomiser(APAutoPatchInterface, metaclass=AutoPatchRegister):
    ...
    @staticmethod
    def patch(patcher: WiiIsoPatcher, patch_path: str) -> None:
        ...
        patch = Patch(patcher, patch_path, output)
