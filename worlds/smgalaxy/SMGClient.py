...
class GalaxyContext(CommonContext):
    ...
    def __init__(self, server_address, password):
        ...
        star_colour_pointers = {value.in_game_name + "Colours" + str(index): Pointer([], ValueType.u8, STAR_COLOUR_LIST_OFFSET + value.region_offset + index) for index in range(8) for value in region_list.values() if value.region_offset is not None}
