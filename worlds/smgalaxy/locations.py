...
locGL_table: dict[str, SMGLocationData]  = {
    locname.GOLDLEAFSTAR1: SMGLocationData(["Gold Leaf Galaxy", "Power Star Locations"], regname.GOLDLEAF, 170000074, game_address=0),
    locname.GOLDLEAFSTAR2: SMGLocationData(["Gold Leaf Galaxy", "Power Star Locations"], regname.GOLDLEAF, 170000075, game_address=1),
    locname.GOLDLEAFSTAR3: SMGLocationData(["Gold Leaf Galaxy", "Power Star Locations"], regname.GOLDLEAF, 170000076, game_address=2),
    locname.GOLDLEAFSTAR4: SMGLocationData(["Gold Leaf Galaxy", "Power Star Locations"], regname.GOLDLEAF, 170000077, game_address=3),
    locname.GOLDLEAFSTAR5: SMGLocationData(["Gold Leaf Galaxy", "Power Star Locations"], regname.GOLDLEAF, 170000079, game_address=4)
}
#TODO: Change abbrivation
locSS_table: dict[str, SMGLocationData]  = {
    locname.SEASLIDESTAR1: SMGLocationData(["Sea Slide Galaxy", "Power Star Locations"], regname.SEASLIDE, 170000080, game_address=0),
    locname.SEASLIDESTAR2: SMGLocationData(["Sea Slide Galaxy", "Power Star Locations"], regname.SEASLIDE, 170000081, game_address=1),
    locname.SEASLIDESTAR3: SMGLocationData(["Sea Slide Galaxy", "Power Star Locations"], regname.SEASLIDE, 170000082, game_address=2),
    locname.SEASLIDESTAR4: SMGLocationData(["Sea Slide Galaxy", "Power Star Locations"], regname.SEASLIDE, 170000083, game_address=3),
    locname.SEASLIDESTAR5: SMGLocationData(["Sea Slide Galaxy", "Power Star Locations"], regname.SEASLIDE, 170000085, game_address=4)
}

locTT_table: dict[str, SMGLocationData]  = {
    locname.TOYTIMESTAR1: SMGLocationData(["Toy Time Galaxy", "Power Star Locations"], regname.TOYTIME, 170000086, game_address=0),
    locname.TOYTIMESTAR2: SMGLocationData(["Toy Time Galaxy", "Power Star Locations"], regname.TOYTIME, 170000087, game_address=1),
    locname.TOYTIMESTAR3: SMGLocationData(["Toy Time Galaxy", "Power Star Locations"], regname.TOYTIME, 170000088, game_address=2),
    locname.TOYTIMESTAR4: SMGLocationData(["Toy Time Galaxy", "Power Star Locations"], regname.TOYTIME, 170000089, game_address=3),
    locname.TOYTIMESTAR5: SMGLocationData(["Toy Time Galaxy", "Power Star Locations"], regname.TOYTIME, 170000090, game_address=4)
}

locDD_table: dict[str, SMGLocationData]  = {
    locname.DEEPDARKSTAR1: SMGLocationData(["Deep Dark Galaxy", "Power Star Locations"], regname.DEEPDARK, 170000092, game_address=0),
    locname.DEEPDARKSTAR2: SMGLocationData(["Deep Dark Galaxy", "Power Star Locations"], regname.DEEPDARK, 170000093, game_address=1),
    locname.DEEPDARKSTAR3: SMGLocationData(["Deep Dark Galaxy", "Power Star Locations"], regname.DEEPDARK, 170000094, game_address=2),
    locname.DEEPDARKSTAR4: SMGLocationData(["Deep Dark Galaxy", "Power Star Locations"], regname.DEEPDARK, 170000095, game_address=3),
    locname.DEEPDARKSTAR5: SMGLocationData(["Deep Dark Galaxy", "Power Star Locations"], regname.DEEPDARK, 170000097, game_address=4)
}

locDN_table: dict[str, SMGLocationData]  = {
    locname.DREADNOUGHTSTAR1: SMGLocationData(["Dreadnought Galaxy", "Power Star Locations"], regname.DREADNOUGHT, 170000098, game_address=0),
    locname.DREADNOUGHTSTAR2: SMGLocationData(["Dreadnought Galaxy", "Power Star Locations"], regname.DREADNOUGHT, 170000099, game_address=1),
    locname.DREADNOUGHTSTAR3: SMGLocationData(["Dreadnought Galaxy", "Power Star Locations"], regname.DREADNOUGHT, 170000100, game_address=2),
    locname.DREADNOUGHTSTAR4: SMGLocationData(["Dreadnought Galaxy", "Power Star Locations"], regname.DREADNOUGHT, 170000101, game_address=3),
    locname.DREADNOUGHTSTAR5: SMGLocationData(["Dreadnought Galaxy", "Power Star Locations"], regname.DREADNOUGHT, 170000103, game_address=4)
}

locMM_table: dict[str, SMGLocationData]  = {
    locname.MELTYMOLTENSTAR1: SMGLocationData(["Melty Molten Galaxy", "Power Star Locations"], regname.MELTY, 170000104, game_address=0),
    locname.MELTYMOLTENSTAR2: SMGLocationData(["Melty Molten Galaxy", "Power Star Locations"], regname.MELTY, 170000105, game_address=1),
    locname.MELTYMOLTENSTAR3: SMGLocationData(["Melty Molten Galaxy", "Power Star Locations"], regname.MELTY, 170000106, game_address=2),
    locname.MELTYMOLTENSTAR4: SMGLocationData(["Melty Molten Galaxy", "Power Star Location"], regname.MELTY, 170000107, game_address=3),
    locname.MELTYMOLTENSTAR5: SMGLocationData(["Melty Molten Galaxy", "Power Star Location"], regname.MELTY, 170000109, game_address=4)
}

locHL_table: dict[str, SMGLocationData]  = {
    locname.SWEETSWEETSTAR: SMGLocationData(["Sweet Sweet Galaxy", "Power Star Location"], regname.SWEETSWEET, 170000110, game_address=0),
    locname.SLINGPODSTAR: SMGLocationData(["Sling Pod Galaxy", "Power Star Location"], regname.SLINGPOD, 170000111, game_address=0),
    locname.DRIPDROPSTAR: SMGLocationData(["Drip Drop Galaxy", "Power Star Location"], regname.DRIPDROP, 170000112, game_address=0),
    locname.BIGMOUTHSTAR: SMGLocationData(["Bigmouth Galaxy", "Power Star Location"], regname.BIGMOUTH, 170000113, game_address=0),
    locname.SANDSPIRALSTAR: SMGLocationData(["Sand Spiral Galaxy", "Power Star Location"], regname.SANDSPIRAL, 170000114, game_address=0),
    locname.BOOSBONEYARDSTAR: SMGLocationData(["Boo's Boneyard Galaxy", "Power Star Location"], regname.BOOBONE, 170000115, game_address=0),
    locname.SNOWCAPSTAR: SMGLocationData(["Snow Cap Galaxy", "Power Star Location"], regname.SNOWCAP, 170000116, game_address=0)
}

locPC_table: dict[str, SMGLocationData]  = {
    locname.TOYTIMESTAR6: SMGLocationData(["Toy Time Galaxy", "Power Star Location", "Purple Coins"], regname.TOYTIME, 170000091, game_address=5),
    locname.DREADNOUGHTSTAR6: SMGLocationData(["Dreadnought Galaxy", "Power Star Location", "Purple Coins"], regname.DREADNOUGHT, 170000102, game_address=5),
    locname.MELTYMOLTENSTAR6: SMGLocationData(["Melty Molten Galaxy", "Power Star Location", "Purple Coins"], regname.MELTY, 170000108, game_address=5),
    locname.DEEPDARKSTAR6: SMGLocationData(["Deep Dark Galaxy", "Power Star Location", "Purple Coins"], regname.DEEPDARK, 170000096, game_address=5),
    locname.SEASLIDESTAR6: SMGLocationData(["Sea Slide Galaxy", "Power Star Location", "Purple Coins"], regname.SEASLIDE, 170000084, game_address=5),
    ...
    locname.GOLDLEAFSTAR6: SMGLocationData(["Gold Leaf Galaxy", "Power Star Location", "Purple Coins"], regname.GOLDLEAF, 170000078, game_address=5),
