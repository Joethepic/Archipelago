...
region_list: dict[str, SMGRegionData] = {
    ...
    regname.GATEWAY: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x0),
    regname.SWEETSWEET: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x14),
    regname.SLINGPOD: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x2C),
    regname.DRIPDROP: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x44),
    regname.BIGMOUTH: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x90),
    regname.SANDSPIRAL: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x78),
    regname.SNOWCAP: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x60),
    regname.BOOBONE: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x48),
    regname.ROLLINGGIZ: SMGRegionData("Special", [regname.TRIALS], [], [], {}, 0x98),
    regname.LOOPDEESWOOP: SMGRegionData("Special", [regname.TRIALS], [], [], {}, 0x9C),
    regname.BUBBLEBLAST: SMGRegionData("Special", [regname.TRIALS], [], [], {}, 0xA0),
    #regname.FINALE: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0xA4),
    regname.BOWJR1: SMGRegionData("Boss", [regname.TERRACE], [], [], {}, 0x18),
    regname.BOWJR2: SMGRegionData("Boss", [regname.KITCHEN], [], [], {}, 0x4C),
    regname.BOWJR3: SMGRegionData("Boss", [regname.ENGINE], [], [], {}, 0x7C),
    regname.BOWSER1: SMGRegionData("Boss", [regname.FOUNTAIN], [], [], {}, 0x30),
    regname.BOWSER2: SMGRegionData("Boss", [regname.BEDROOM], [], [], {}, 0x64),
    regname.BOWSER3: SMGRegionData("Goal", [regname.COTU], [], [], {}, 0x94),
    regname.GOODEGG: SMGRegionData("Major", [regname.TERRACE], [], [], {}, 0x4),
    regname.HONEYHIVE: SMGRegionData("Major", [regname.TERRACE], [], [], {}, 0x8),
    regname.SPACEJUNK: SMGRegionData("Major", [regname.FOUNTAIN], [], [], {}, 0x20),
    regname.BATTLEROCK: SMGRegionData("Major", [regname.FOUNTAIN], [], [], {}, 0x24),
    regname.BEACHBOWL: SMGRegionData("Major", [regname.KITCHEN], [], [], {}, 0x34),
    regname.GHOSTLY: SMGRegionData("Major", [regname.KITCHEN], [], [], {}, 0x3C),
    regname.GUSTY: SMGRegionData("Major", [regname.BEDROOM], [], [], {}, 0x50),
    regname.FREEZEFLAME: SMGRegionData("Major", [regname.BEDROOM], [], [], {}, 0x54),
    regname.DUSTY: SMGRegionData("Major", [regname.BEDROOM], [], [], {}, 0x5C),
    regname.GOLDLEAF: SMGRegionData("Major", [regname.ENGINE], [], [], {}, 0x68),
    regname.SEASLIDE: SMGRegionData("Major", [regname.ENGINE], [], [], {}, 0x6C),
    regname.TOYTIME: SMGRegionData("Major", [regname.ENGINE], [], [], {}, 0x74),
    regname.DEEPDARK: SMGRegionData("Major", [regname.GARDEN], [], [], {}, 0x80),
    regname.DREADNOUGHT: SMGRegionData("Major", [regname.GARDEN], [], [], {}, 0x84),
    regname.MELTY: SMGRegionData("Major", [regname.GARDEN], [], [], {}, 0x8C),
    regname.LOOPDEELOOP: SMGRegionData("Minor", [regname.TERRACE], [], [], {}, 0xC),
    regname.FLIPSWITCH: SMGRegionData("Minor", [regname.TERRACE], [], [], {}, 0x10),
    regname.ROLLINGGREEN: SMGRegionData("Minor", [regname.FOUNTAIN], [], [], {}, 0x1C),
    regname.HURRYSCUR: SMGRegionData("Minor", [regname.FOUNTAIN], [], [], {}, 0x28),
    regname.BUBBLEBREEZE: SMGRegionData("Minor", [regname.KITCHEN], [], [], {}, 0x38),
    regname.BUOY: SMGRegionData("Minor", [regname.KITCHEN], [], [], {}, 0x40),
    regname.HONEYCLIMB: SMGRegionData("Minor", [regname.BEDROOM], [], [], {}, 0x58),
    regname.BONEFIN: SMGRegionData("Minor", [regname.ENGINE], [], [], {}, 0x70),
    regname.MATTER: SMGRegionData("Minor", [regname.GARDEN], [], [], {}, 0x88),
