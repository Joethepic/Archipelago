...
def create_regions(player: int, self: int):
    #defines the commet obserbatory
    regspecialstages = Region("Menu", RegionType.Generic, "Ship", player, multiworld)
    ...
    if self.multiworld.enable_purple_coin_stars[self.player].value == 0:
    ...
    multiworld.regions.append(regspecialstages)
    # defines the good egg galaxy region
    regGE = Region("Good Egg", RegionType.Generic, "Good Egg", player, multiworld)
    ...
    multiworld.regions.append(regGE)    
    # defines the honeyhive galaxey region
    regHH = Region("Honeyhive", RegionType.Generic, "Honeyhive", player, multiworld)
    ...
    multiworld.regions.append(regHH)    
    # defines the Space Junk galaxy region
    regSJ = Region("Space Junk", RegionType.Generic, "Space Junk", player, multiworld)
    ...
    multiworld.regions.append(regSJ)  
    # defines the Battlerock galaxy
    regBR = Region("Battlerock", RegionType.Generic, "Battlerock", player, multiworld)
    ...
    multiworld.regions.append(regBR)     
    # defines the Beach Bowl galaxy
    regBB = Region("Beach Bowl", RegionType.Generic, "Beach Bowl", player, multiworld)
    ...
    multiworld.regions.append(regBB)  
    # define Ghostly galaxy
    regG = Region("Ghostly", RegionType.Generic, "Ghostly", player, multiworld)
    ...
    multiworld.regions.append(regG)  
    # defines the Gusty Gardens galaxy 
    regGG = Region("Gusty Gardens", RegionType.Generic, "Gusty Gardens", player, multiworld)
    ...
    multiworld.regions.append(regGG)  
    # defines Freezeflame galaxy
    regFF = Region("Freezeflame", RegionType.Generic, "Freezeflame", player, multiworld)
    ...
    multiworld.regions.append(regFF)  
    # defines DustyDune Galaxy
    regDDune = Region("Dusty Dune", RegionType.Generic, "Dusty Dune", player, multiworld)
    ...
    multiworld.regions.append(regDDune)  
    # defines golden leaf galaxy
    regGL = Region("Gold Leaf", RegionType.Generic, "Gold Leaf", player, multiworld)
    ...
    multiworld.regions.append(regGL)  
    # defines the Sea slide galaxy
    regSS = Region("Sea Slide", RegionType.Generic, "Sea Slide", player, multiworld)
    ...
    regTT = Region ("Toy Time", RegionType.Generic, "Toy Time", player, multiworld)
    ...
    multiworld.regions.append(regTT)  
    # defines deep dark galaxy
    regDD = Region("Deep Dark", RegionType.Generic, "Deep Dark", player, multiworld)
    ...
    multiworld.regions.append(regDD)  
    # defines Dreadnaught galaxy
    regDN = Region("Dreadnaught", RegionType.Generic, "Dreadnaught", player, multiworld)
    ...
    multiworld.regions.append(regDN)  
    # defines Melty Molten galaxy
    regMM = Region("Melty Molten", RegionType.Generic, "Melty Molten", player, multiworld)
    ...
    multiworld.regions.append(regMM)  
    #defines the fountain
    regFountain = Region("Fountain", RegionType.Generic, "Fountain", player, multiworld)
    multiworld.regions.append(regFountain)
    #defines the kitchen
    regKitchen = Region("Kitchen", RegionType.Generic, "Kitchen", player, multiworld)
    multiworld.regions.append(regKitchen)
    #defines the bedroom
    regBedroom = Region("Bedroom", RegionType.Generic, "Bedroom", player, multiworld)
    multiworld.regions.append(regBedroom)
    #defines the Engine Room
    regEngineRoom = Region("Engine Room", RegionType.Generic, "Engine Room", player, multiworld)
    multiworld.regions.append(regEngineRoom)
    #defines the garden
