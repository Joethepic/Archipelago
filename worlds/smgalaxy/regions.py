...
def create_regions(world: MultiWorld, player: int, self: int):
    ...
    regspecialstages = create_region("GatewayGalaxy", player, world)
    ...
    regSJ = create_regions("Space Junk", player, world)
    ...
    regBR = create_regions("Battlerock", player, world)
    ...
    regBB = create_regions("Beach Bowl", player, world)
    ...
    regG = create_regions("Ghostly", player, world)
    ...
    regGG = create_regions("Gusty Gardens", player, world)
    ...
    regFF = create_regions("Freezeflame", player, world)
    ...
    regDDune = create_regions("Dusty Dune", player, world)
    ...
    regGL = create_regions("Gold Leaf", player, world)
    ...
    regSS = create_regions("Sea Slide", player, world)
    ...
    regTT = create_regions ("Toy Time", player, world)
    ...
    regDD = create_regions("Deep Dark", player, world)
    ...
    regDN = create_regions("Dreadnaught", player, world)
    ...
    regMM = create_regions("Melty Molten", player, world)
