...
region_list: dict[str, SMGRegionData] = {
    ...
    regname.GATEWAY: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x0, galaxyIG.GATEWAY),
    regname.SWEETSWEET: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x14, galaxyIG.SWEETSWEET),
    regname.SLINGPOD: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x2C, galaxyIG.SLINGPOD),
    regname.DRIPDROP: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x44, galaxyIG.DRIPDROP),
    regname.BIGMOUTH: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x90, galaxyIG.BIGMOUTH),
    regname.SANDSPIRAL: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x78, galaxyIG.SANDSPIRAL),
    regname.SNOWCAP: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x60, galaxyIG.SNOWCAP),
    regname.BOOBONE: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0x48, galaxyIG.BOOBONE),
    regname.ROLLINGGIZ: SMGRegionData("Special", [regname.TRIALS], [], [], {}, 0x98, galaxyIG.ROLLINGGIZ),
    regname.LOOPDEESWOOP: SMGRegionData("Special", [regname.TRIALS], [], [], {}, 0x9C, galaxyIG.LOOPDEESWOOP),
    regname.BUBBLEBLAST: SMGRegionData("Special", [regname.TRIALS], [], [], {}, 0xA0, galaxyIG.BUBBLEBLAST),
    #regname.FINALE: SMGRegionData("Special", [regname.SHIP], [], [], {}, 0xA4, "PeachCastleFinalGalaxy"),
    regname.BOWJR1: SMGRegionData("Boss", [regname.TERRACE], [], [], {}, 0x18, galaxyIG.BOWJR1),
    regname.BOWJR2: SMGRegionData("Boss", [regname.KITCHEN], [], [], {}, 0x4C, galaxyIG.BOWJR2),
    regname.BOWJR3: SMGRegionData("Boss", [regname.ENGINE], [], [], {}, 0x7C, galaxyIG.BOWSER3), # Dome 5
    regname.BOWSER1: SMGRegionData("Boss", [regname.FOUNTAIN], [], [], {}, 0x30, galaxyIG.BOWSER1),
    regname.BOWSER2: SMGRegionData("Boss", [regname.BEDROOM], [], [], {}, 0x64, galaxyIG.BOWSER2),
    regname.BOWSER3: SMGRegionData("Goal", [regname.COTU], [], [], {}, 0x94, galaxyIG.BOWSER3),
    regname.GOODEGG: SMGRegionData("Major", [regname.TERRACE], [], [], {}, 0x4, galaxyIG.GOODEGG),
    regname.HONEYHIVE: SMGRegionData("Major", [regname.TERRACE], [], [], {}, 0x8, galaxyIG.HONNEYHIVE),
    regname.SPACEJUNK: SMGRegionData("Major", [regname.FOUNTAIN], [], [], {}, 0x1C, galaxyIG.SPACEJUNK),
    regname.BATTLEROCK: SMGRegionData("Major", [regname.FOUNTAIN], [], [], {}, 0x24, galaxyIG.BATTLEROCK),
    regname.BEACHBOWL: SMGRegionData("Major", [regname.KITCHEN], [], [], {}, 0x34, galaxyIG.BEACHBOWL),
    regname.GHOSTLY: SMGRegionData("Major", [regname.KITCHEN], [], [], {}, 0x3C, galaxyIG.GHOSTLY),
    regname.GUSTY: SMGRegionData("Major", [regname.BEDROOM], [], [], {}, 0x50, galaxyIG.GUSTY),
    regname.FREEZEFLAME: SMGRegionData("Major", [regname.BEDROOM], [], [], {}, 0x54, galaxyIG.FREEZEFLAME),
    regname.DUSTY: SMGRegionData("Major", [regname.BEDROOM], [], [], {}, 0x5C, galaxyIG.DUSTYDUNE),
    regname.GOLDLEAF: SMGRegionData("Major", [regname.ENGINE], [], [], {}, 0x68, galaxyIG.GOLDLEAF),
    regname.SEASLIDE: SMGRegionData("Major", [regname.ENGINE], [], [], {}, 0x6C, galaxyIG.SEASLIDE),
    regname.TOYTIME: SMGRegionData("Major", [regname.ENGINE], [], [], {}, 0x74, galaxyIG.TOYTIME),
    regname.DEEPDARK: SMGRegionData("Major", [regname.GARDEN], [], [], {}, 0x80, galaxyIG.DEEPDARK),
    regname.DREADNOUGHT: SMGRegionData("Major", [regname.GARDEN], [], [], {}, 0x84, galaxyIG.DREADNOUGHT),
    regname.MELTY: SMGRegionData("Major", [regname.GARDEN], [], [], {}, 0x8C, galaxyIG.MELTY),
    regname.LOOPDEELOOP: SMGRegionData("Minor", [regname.TERRACE], [], [], {}, 0xC, galaxyIG.LOOPDEELOOP),
    regname.FLIPSWITCH: SMGRegionData("Minor", [regname.TERRACE], [], [], {}, 0x10, galaxyIG.FLIPSWITCH),
    regname.ROLLINGGREEN: SMGRegionData("Minor", [regname.FOUNTAIN], [], [], {}, 0x20, galaxyIG.ROLLINGGREEN),
    regname.HURRYSCUR: SMGRegionData("Minor", [regname.FOUNTAIN], [], [], {}, 0x28, galaxyIG.HURRYSCURRY),
    regname.BUBBLEBREEZE: SMGRegionData("Minor", [regname.KITCHEN], [], [], {}, 0x38, galaxyIG.BUBBLEBREEZE),
    regname.BUOY: SMGRegionData("Minor", [regname.KITCHEN], [], [], {}, 0x40, galaxyIG.BUOY),
    regname.HONEYCLIMB: SMGRegionData("Minor", [regname.BEDROOM], [], [], {}, 0x58, galaxyIG.HONEYCLIMB),
    regname.BONEFIN: SMGRegionData("Minor", [regname.ENGINE], [], [], {}, 0x70, galaxyIG.BONEFIN),
    regname.MATTER: SMGRegionData("Minor", [regname.GARDEN], [], [], {}, 0x88, galaxyIG.MATTER),
