...
region_list: dict[str, SMGRegionData] = {
    ...
    regname.COTU: SMGRegionData("Dome", [regname.SHIP], [], [regname.BOWSER3]),
    ...
    regname.TRIALS: SMGRegionData("Hub", [], [regname.SHIP], [regname.LOOPDEESWOOP, regname.BUBBLEBLAST, regname.ROLLINGGIZ]),
}
